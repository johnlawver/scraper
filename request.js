...
let createEmail = newHire => {
  ...
  newHire.adName = `${newHire.firstName
    .split(' ')
    .join('')}.${newHire.lastName.split(' ').join('')}`.toLocaleLowerCase();
...
newHire.firstName = request.fields.customfield_10124
  ? request.fields.customfield_10124
  : 'NOT DEFINED';
newHire.lastName = request.fields.customfield_10125
  ? request.fields.customfield_10125
  : 'NOT DEFINED';
newHire.preferredName = request.fields.customfield_10126
  ? request.fields.customfield_10126
  : 'None';
newHire.name = createName(newHire);
newHire.startDate = request.fields.customfield_10129
  ? request.fields.customfield_10129
  : 'NOT DEFINED';
newHire.title = request.fields.customfield_10127
  ? request.fields.customfield_10127
  : 'NOT DEFINED';
newHire.manager = request.fields.customfield_10128
  ? request.fields.customfield_10128
  : 'NOT DEFINED';
newHire.personToMirror = request.fields.customfield_10132
  ? request.fields.customfield_10132
  : 'None';
newHire.vpn = request.fields.customfield_10136
  ? request.fields.customfield_10136.value
  : 'No';
newHire.emailAccess = request.fields.customfield_10141.value
  ? request.fields.customfield_10141.value
  : 'No';
newHire.cubicle = request.fields.customfield_10140
  ? request.fields.customfield_10140
  : 'NOT DEFINED';
newHire.labelsArray = request.fields.labels
  ? request.fields.labels
  : 'NOT DEFINED';
newHire.location = request.fields.customfield_10104.value
  ? request.fields.customfield_10104.value
  : 'NOT DEFINED';
newHire.department = request.fields.customfield_10109.value
  ? request.fields.customfield_10109.value
  : 'NOT DEFINED';
newHire.teamMemberType = request.fields.customfield_10111
  ? request.fields.customfield_10111.value
  : 'Core';
newHire.classification = request.fields.customfield_10131
  ? request.fields.customfield_10131.value
  : 'NOT DEFINED';
